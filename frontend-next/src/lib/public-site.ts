  ...
  plans: [
    {
      name: 'Growth',
      price: '$79/mo',
      commitment: 'Best for up to 100 employees',
      description: 'Launch HRMS essentials with attendance, documents, tasks, and employee self-service.',
      cta: 'Start with Growth',
      features: ['Employee directory', 'Attendance + leave', 'Document center', 'Starter automations'],
    },
    {
      name: 'Professional',
      price: '$249/mo',
      commitment: 'Best for multi-team operations',
      description: 'Add payroll, CRM, analytics, location tracking, and manager dashboards for growing companies.',
      featured: true,
      cta: 'Book Professional demo',
      features: ['Payroll + performance', 'CRM + sales visibility', 'Analytics cockpit', 'Department governance'],
    },
    {
      name: 'Enterprise',
      price: 'Custom',
      commitment: 'For high-scale and multi-entity rollout',
      description: 'Sovereign architecture, white-label options, advanced security controls, and executive success coverage.',
      cta: 'Talk to enterprise team',
      features: ['Multi-company rollout', 'White-label branding', 'Priority onboarding', 'Governance + security support'],
    },
  ],
  testimonials: [
    {
...
export const OMNIX_A2Z_HERO: PublicA2zPayload['hero'] = {
...
export const OMNIX_A2Z_SERVICE_SUITES: PublicA2zPayload['serviceSuites'] = [
  {
...
export const OMNIX_A2Z_WORKFLOW_STEPS: PublicA2zPayload['workflowSteps'] = [
  {
    id: 'atlas-discovery',
...
export const OMNIX_A2Z_ASSURANCES: PublicA2zPayload['assurances'] = [
  {
...
export const OMNIX_A2Z_FORM_OPTIONS: PublicA2zPayload['formOptions'] = {
  serviceBundles: [
...
export const OMNIX_A2Z_ACTIVE_MODULES = new Set(OMNIX_A2Z_SERVICE_SUITES.flatMap((suite) => suite.modules)).size;
