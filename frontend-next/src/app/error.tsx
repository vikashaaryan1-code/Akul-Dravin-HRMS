    ...
    <main className="flex min-h-screen flex-col items-center justify-center gap-8 bg-[#02060f] px-6 text-center">
      ...
      <div className="relative z-10 flex max-w-md flex-col items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={reset}
            className="rounded-2xl bg-gradient-to-r from-aqua to-aqua/80 px-6 py-3 text-sm font-bold text-white transition-all hover:shadow-lg hover:shadow-aqua/25 active:scale-95"
          >
            Try again
          </button>
          <Link
            href="/dashboard"
            className="rounded-2xl border border-slate-700 bg-slate-800/50 px-6 py-3 text-sm font-semibold text-slate-300 transition-all hover:bg-slate-800 hover:text-white"
          >
            Go to Dashboard
          </Link>
        </div>
