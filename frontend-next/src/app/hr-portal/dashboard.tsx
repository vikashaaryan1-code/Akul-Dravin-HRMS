...
export default function HrDashboard() {
 ...
 /* Mock data for charts */ const attendanceData = [
 ...
 return (
 <div className="min-h-screen bg-slate-50 text-white p-6 md:p-8">
 {/* Header */}
 <div className="mb-10">
 <h1 className="text-4xl font-bold gradient-title mb-2">HR Management Dashboard</h1>
 <p className="text-slate-500">Real-time workforce intelligence & AI-powered insights</p>
 </div>

 {/* Key Metrics */}
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
 <Card className="!bg-slate-50/40 hover:!bg-slate-50/60 border border-slate-200/30">
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-slate-500 text-sm font-medium">Today Present</p>
 ...
 <div>
 <p className="text-slate-500 text-sm">{insight.title}</p>
 ...
 <th className="text-left py-3 px-4 text-slate-500 font-semibold">Employee</th>
 <th className="text-left py-3 px-4 text-slate-500 font-semibold">Type</th>
 <th className="text-left py-3 px-4 text-slate-500 font-semibold">Details</th>
 <th className="text-left py-3 px-4 text-slate-500 font-semibold">Status</th>
 <th className="text-center py-3 px-4 text-slate-500 font-semibold">Action</th>
 </tr>
 </thead>
 <tbody>
 {pendingApprovals.map((approval) => (
 <tr key={approval.id} className="border-b border-slate-200/20 hover:bg-slate-50/40">
