...
export default function FeaturesPage() {
 ...
 <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-aqua/10 blur-[120px]" />
 <div className="absolute bottom-[10%] right-[-5%] w-[30%] h-[40%] bg-ember/5 blur-[100px]" />
 </div>
 ...
 className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-navy/10 bg-navy/5 text-[10px] font-black uppercase tracking-[0.3em] text-aqua"
 >
 ...
 <span className="bg-gradient-to-r from-aqua via-cyan to-jade bg-clip-text text-transparent">Absolute Certainty</span>
 </motion.h1>
 ...
 >
 AKUL DRAVIN is not just an ERP; it's a self-regulating operating system for high-stakes business logic and financial truth.
 </motion.p>
 </div>
 </section>
 ...
 <div key={point} className="flex gap-4 p-4 rounded-2xl border border-navy/5 bg-navy/[0.02] hover:bg-navy/[0.04] transition-colors group">
 <div className="mt-1 w-1.5 h-1.5 rounded-full bg-cyan group-hover:scale-150 transition-transform" />
 ...
 >
 <div className="absolute inset-0 bg-gradient-to-br from-aqua/10 to-jade/10 rounded-[3rem] blur-2xl" />
 <div className="relative h-full w-full glass-3d-panel flex items-center justify-center p-12">
 <cluster.icon className={`w-32 h-32 ${
 cluster.color === 'blue' ? 'text-aqua' : 
 cluster.color === 'amber' ? 'text-gold' : 'text-jade'
 } drop-shadow-[0_0_30px_rgba(15,139,141,0.2)]`} />
 </div>
 </motion.div>
 </div>
 ))}
 ...
 {/* Conversion CTA */}
 <section className="px-4 py-32 lg:px-8 border-t border-navy/5 relative overflow-hidden">
 <div className="absolute inset-0 bg-aqua/[0.02] pointer-events-none" />
 <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
 <h2 className="text-4xl font-bold tracking-tight">Ready to certify your operations?</h2>
 <p className="text-slate-500">Experience the power of an autonomous financial OS today.</p>
 <div className="flex flex-wrap justify-center gap-4">
 <Link 
 href="/login" 
 className="px-8 py-4 rounded-full btn-primary font-bold text-sm tracking-widest hover:scale-105 transition-transform"
 >
 GET STARTED
 </Link>
 <Link 
