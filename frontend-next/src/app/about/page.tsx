...
const PHILOSOPHY_PILLARS = [
  {
    ...
    description: "Traditional software follows rigid code; OMNIX follows real-time intelligence. Our autonomic systems sense operational drift and stabilize your business before humans even notice."
  },
  {
    icon: Dna,
    title: "Financial DNA",
      ...
      <main className="relative pt-24 overflow-hidden">
        ...
        <section className="relative px-4 py-24 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 text-[10px] font-black uppercase tracking-[0.4em] text-blue-400 mb-8"
          >
          ...
          >
            From Management <br />
            To <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-emerald-400 bg-clip-text text-transparent">Autonomy</span>
          </motion.h1>
          ...
          >
            ...
            OMNIX replaces administrative friction with mathematical certainty.
          </motion.p>
        </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {PHILOSOPHY_PILLARS.map((pillar, idx) => (
              <motion.div 
                ...
                className="p-10 ultra-glass rounded-[3rem] border border-white/10 flex flex-col gap-6 group hover:bg-white/[0.04] transition-all"
              >
                <div className="w-16 h-16 rounded-[1.5rem] bg-gradient-to-br from-blue-500/10 to-emerald-500/10 border border-white/10 flex items-center justify-center text-blue-400">
           ...
           <div className="max-w-4xl mx-auto text-center space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-12 text-left">
                  <div className="space-y-4">
                      <p className="text-sm font-bold text-cyan-400 uppercase tracking-widest">Our Mission</p>
                      <p className="text-slate-300 leading-8 italic border-l-2 border-cyan-500/30 pl-6">
                  ...
                  <div className="space-y-4">
                      <p className="text-sm font-bold text-emerald-400 uppercase tracking-widest">Our Vision</p>
        ...
        {/* Global Hub CTA */}
        <section className="px-4 py-32 lg:px-8 border-t border-white/5 text-center">
            <h3 className="text-2xl font-bold mb-8">Scale with Sovereignty</h3>
            <div className="flex justify-center gap-6">
                 <button className="flex items-center gap-3 px-8 py-4 rounded-full bg-white text-[#04101f] font-bold text-xs tracking-widest hover:scale-105 transition-all">
                    VIEW CAREERS <ArrowRight className="w-4 h-4" />
                 </button>
                 <button className="flex items-center gap-3 px-8 py-4 rounded-full border border-white/10 bg-white/5 text-white font-bold text-xs tracking-widest hover:bg-white/10 transition-all">
                    OUR ROADMAP
                 </button>
            </div>
        </section>
