...
export default function EmployeePortal() {
 ...
 /* Mock employee data */ const employee = {
 name: 'Rahul Verma',
 id: 'EMP001234',
 ...
 {/* Mobile Header */}
 <div className="sticky top-0 bg-white/95 backdrop-blur border-b border-slate-200/30 p-4 z-10">
 <h1 className="text-2xl font-bold">Employee Portal</h1>
 <p className="text-sm text-slate-500">{employee.name} • {employee.designation}</p>
 </div>
 ...
 {/* Tab Navigation */}
 <div className="flex gap-2 mb-6 border-b border-slate-200/30 overflow-x-auto">
 ...
 <div>
 <p className="text-slate-500 text-sm">Employee ID</p>
 ...
 <div>
 <p className="text-slate-500 text-sm">Reporting Manager</p>
 ...
 <p className="text-sm text-slate-600 mt-1">You have 10 casual leaves remaining. Plan your vacation!</p>
 </div>
 </div>
 </Card>
 </div>
 ...
 <div
 key={idx}
 className="flex justify-between items-center py-3 border-b border-slate-200/20 last:border-0"
 >
 ...
 <div className="flex justify-between">
 <span className="text-slate-500">Days Leave</span>
 ...
 <select className="w-full bg-slate-50 border border-slate-600 rounded px-3 py-2 text-white">
 ...
 <input type="date" className="w-full bg-slate-50 border border-slate-600 rounded px-3 py-2 text-white" />
 </div>
 <div>
 ...
 <textarea className="w-full bg-slate-50 border border-slate-600 rounded px-3 py-2 text-white h-24" />
 </div>
 ...
 <div
 key={idx}
 className="flex justify-between items-center py-3 px-3 bg-slate-50/40 rounded border border-slate-200/20"
 >
 <div>
 <p className="font-medium">{payslip.month}</p>
 <p className="text-xs text-slate-500">{payslip.grossSalary} • {payslip.ctc}</p>
 </div>
 ...
 <p className="text-xs text-slate-500 mt-1">Current Rating</p>
 </div>
 <div className="text-center">
 ...
 <p className="text-xs text-slate-500 mt-1">Peer Reviews</p>
 </div>
 </div>
 </Card>
