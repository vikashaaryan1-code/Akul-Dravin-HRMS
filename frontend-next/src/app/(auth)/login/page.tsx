...
function LoginContent() {
  ...
  // Setup nudge
  const [mfaSetupNudge,  setMfaSetupNudge]  = useState(false);
  ...
  const handleGoogleLogin = () => {
    // Store ?next= destination so OAuth callback can redirect there
            ...
            <>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  type="button"
                  id="system-status"
                  className="flex items-center justify-center gap-2 rounded-xl glass-3d-panel py-2.5 text-[11px] font-bold text-slate-400 transition-all hover:border-white/10 hover:bg-white/10"
                >
