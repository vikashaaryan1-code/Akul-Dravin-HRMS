...
export default function SignupPage() {
 ...
 /* Set cookie for middleware */ const parts = data.accessToken.split('.');
 ...
 >
 {INDUSTRIES.map((ind) => (
 <option key={ind} value={ind} className="bg-white text-white">
 {ind}
 </option>
 ))}
 </select>
 ...
 <p className="mt-2 text-slate-500">Welcome to Akul Dravin. Redirecting to your workspace...</p>
 </div>
 )}
