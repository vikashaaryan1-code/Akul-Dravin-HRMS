...
export default function ForgotPasswordPage() {
 ...
 /* Always show success (API prevents email enumeration) */ if (!res.ok) {
 ...
 <Link
 href="/login"
 className="mt-2 inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-6 py-3 text-sm font-bold text-navy transition hover:bg-white/10"
 >
