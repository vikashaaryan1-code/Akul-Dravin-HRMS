  ...
  return (
    <div className="min-h-screen bg-[#04101f] text-white selection:bg-amber/30">
      ...
      <main className="relative pt-24 overflow-hidden">
        {/* Glow Effects */}
        <div className="absolute top-[20%] right-[-10%] w-[50%] h-[50%] bg-blue-500/5 blur-[120px] pointer-events-none" />
        <div className="absolute bottom-[10%] left-[-10%] w-[40%] h-[40%] bg-amber-500/5 blur-[120px] pointer-events-none" />
        ...
        <section className="relative px-4 py-20 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-black tracking-tighter">
              Start Your <br />
              <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-emerald-400 bg-clip-text text-transparent">Autonomic Journey</span>
            </h1>
        ...
        <section className="px-4 py-12 lg:px-8 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div className="space-y-8">
               <div className="flex gap-6 items-start group">
                  <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-blue-400 group-hover:bg-blue-500/10 transition-colors">
               ...
               <div className="flex gap-6 items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-1">sovereign@omnix.io</p>
                    <p className="text-sm text-slate-400">compliance@omnix.io</p>
                  </div>
               </div>

               <div className="flex gap-6 items-start group">
                  <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-amber-400 group-hover:bg-amber-500/10 transition-colors">
                    <ShieldCheck className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className="font-bold text-white tracking-tight">Operational Support</h4>
                    <p className="text-sm text-slate-400 mt-1">24/7 Autonomic Monitoring Active</p>
                    <p className="text-xs font-mono text-white/20 mt-2 uppercase tracking-widest">support_token: forensic-active-88</p>
                  </div>
               </div>
            </div>

            <div className="p-8 ultra-glass rounded-[2rem] border border-blue-500/20 bg-blue-500/5">
          ...
          <motion.div 
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
            className="ultra-glass rounded-[3rem] border border-white/10 p-8 lg:p-12 relative"
          >
            <div className="absolute -top-6 -right-6 p-4 rounded-3xl bg-emerald-500 shadow-[0_10px_30px_rgba(16,185,129,0.3)] rotate-12">
        ...
        <section className="px-4 py-40 lg:px-8 max-w-4xl mx-auto text-center">
            <div className="inline-block relative">
                 ...
                 <Globe className="w-40 h-40 text-blue-400/30 relative animate-[spin_20s_linear_infinite]" />
            </div>
            <p className="text-xs font-black text-white/20 uppercase tracking-[0.5em] mt-12">Universal Hub Connectivity Active</p>
        </section>
      </main>
