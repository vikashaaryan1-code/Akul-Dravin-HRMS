...
/* ── Singleton store ─────────────────────────────────────────────────────────── */ let _toasts: Toast[] = [];
...
export const toastStore = {
 ...
 _listeners.add(fn);
 fn([..._toasts]); /* seed current state */ return () => _listeners.delete(fn);
 },
 ...
 /* Auto-remove */ const timer = setTimeout(() => toastStore.remove(id), duration);
...
/* ── Convenience helpers (callable anywhere, including non-React code) ───────── */ export const toast = {
