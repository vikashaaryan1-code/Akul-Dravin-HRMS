...
// ── useBreakpoint — resolved semantic flags ───────────────────────────────────
...
// ── useMobileNav — sidebar open/close state with body scroll lock ─────────────
...
// ── useTouchDevice — pointer capability detection ─────────────────────────────
