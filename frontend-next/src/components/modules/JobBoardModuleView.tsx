...
export function JobBoardModuleView() {
 ...
 { key: 'location', label: 'Location', sortable: true, render: (v) => <span className="flex items-center gap-1 text-xs"><MapPin className="h-3 w-3 text-slate-500" />{v as string}</span> },
