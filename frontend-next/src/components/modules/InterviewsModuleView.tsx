...
export function InterviewsModuleView() {
  ...
  const columns: ColumnDef<InterviewRow>[] = [
    ...
    { key: 'score', label: 'Score', sortable: true, render: (v) => v !== null ? <span className="font-semibold text-blue-600">{String(v)}%</span> : <span className="text-slate-400 text-xs">Pending</span> },
