...
/* ─── Types ──────────────────────────────────────────────────────────────────── */ type GoalStatus = 'on-track' | 'at-risk' | 'completed' | 'not-started';
...
/* ─── Seed Data ──────────────────────────────────────────────────────────────── */ const OKR_GOALS: OKRGoal[] = [
...
/* ─── OKR Progress Bar ───────────────────────────────────────────────────────── */ function OKRCard({ goal }: { goal: OKRGoal }) {
 ...
 <p className="text-xs font-semibold text-slate-700">{goal.title}</p>
 ...
 <span>Progress</span>
 <span className="font-semibold text-slate-600">{goal.progress}%</span>
 </div>
...
/* ─── Rating Badge ───────────────────────────────────────────────────────────── */ const ratingColors: Record<RatingLabel, string> = {
...
/* ─── Main Component ─────────────────────────────────────────────────────────── */ type ActiveTab = 'okr' | 'reviews' | 'analytics';
...
export function AdvancedPerformanceView() {
 ...
 : 'border-white/10 text-slate-500 hover:text-slate-700'}`}>
 {c}
 </button>
 ))}
 </div>
 ...
 <div>
 <p className="text-sm font-semibold text-slate-700">Overall OKR Score — Q2 2026</p>
 ...
 <td className="py-2.5 px-3 text-slate-700 font-medium">{r.employee}</td>
 <td className="py-2.5 px-3 text-slate-500">{r.department}</td>
 <td className="py-2.5 px-3 text-slate-600">{r.selfScore > 0 ? r.selfScore : '—'}</td>
 <td className="py-2.5 px-3 text-slate-600">{r.managerScore > 0 ? r.managerScore : '—'}</td>
 ...
 <p className="text-sm font-semibold text-slate-700">Rating Distribution — Q2 2026</p>
 ...
 <p className="text-[10px] text-slate-500 leading-tight">{r.label}</p>
