    ...
    <div className="space-y-5">
        ...
        actions={
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              disabled={actionState !== null}
              className="rounded-md border border-slate-300 bg-white px-4 py-2 text-xs font-semibold text-slate-700 disabled:cursor-not-allowed disabled:opacity-60 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
            >
      ...
      <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <GlassCard>
          ...
          <p className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{summary.activeSubscriptions}</p>
        ...
        <GlassCard>
          ...
          <p className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{formatCurrency(summary.recurringRevenue)}</p>
        ...
        <GlassCard>
          ...
          <p className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{formatCurrency(summary.collected)}</p>
        ...
        <GlassCard>
          ...
          <p className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{formatCurrency(summary.receivables)}</p>
      ...
      <section className="grid gap-4 xl:grid-cols-[0.95fr_1.05fr]">
        <GlassCard>
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Billing Health</p>
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
              ...
              <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-slate-100">{formatCurrency(data.financeSummary.totalRevenue)}</p>
            </div>
            <div className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
              <p className="text-xs uppercase tracking-[0.12em] text-slate-500">Expenses</p>
              <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-slate-100">{formatCurrency(data.financeSummary.totalExpenses)}</p>
            </div>
            <div className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
              <p className="text-xs uppercase tracking-[0.12em] text-slate-500">GST Payable</p>
              <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-slate-100">{formatCurrency(data.financeSummary.gstPayable)}</p>
            </div>
            <div className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
              <p className="text-xs uppercase tracking-[0.12em] text-slate-500">Operating Margin</p>
              <p className="mt-2 text-xl font-semibold text-slate-900 dark:text-slate-100">{data.financeSummary.operatingMarginPercent.toFixed(1)}%</p>
            </div>
          </div>
        </GlassCard>

        <GlassCard>
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Collection Notes</p>
          <ul className="mt-4 space-y-2 text-sm text-slate-600 dark:text-slate-300">
            <li className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        <GlassCard>
          <p className="mb-3 text-sm font-semibold text-slate-800 dark:text-slate-100">Subscriptions</p>
          <SimpleTable
        ...
        <GlassCard>
          <p className="mb-3 text-sm font-semibold text-slate-800 dark:text-slate-100">Invoices</p>
          <SimpleTable
            rows={data.invoices}
            columns={[
