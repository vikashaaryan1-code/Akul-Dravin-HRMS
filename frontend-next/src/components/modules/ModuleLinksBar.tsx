...
export function ModuleLinksBar({ links, isLive, loading = false, error = null }: ModuleLinksBarProps) {
 ...
 <span className="rounded-full border border-slate-300 bg-white px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-slate-600 ">
 ...
 href={link.href}
 className="rounded-full border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:border-aqua/40 hover:text-aqua "
 >
 {link.label}
 </Link>
 ))}
