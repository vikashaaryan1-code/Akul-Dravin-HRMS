    ...
    <div className="space-y-5">
      ...
      <section className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Cross-Module Finance Signals</p>
      ...
      <section className="grid gap-4 xl:grid-cols-[1fr_1fr]">
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Invoice Ledger</p>
          <SimpleTable
            rows={invoices}
            columns={[
        ...
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Expense Ledger</p>
          <SimpleTable
            rows={expenses}
            columns={[
