    ...
    <div className="space-y-5">
        ...
        actions={
          <div className="flex flex-col items-start gap-2">
            ...
            {!canCreatePo || !canApprovePo ? (
              <p className="text-[11px] text-amber-700 dark:text-amber-300">Procurement actions are restricted by active role policy.</p>
            ) : null}
          </div>
        }
      />
      ...
      <section className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Spend Governance Notes</p>
      ...
      <section className="grid gap-4 xl:grid-cols-[1fr_1fr]">
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Vendor Directory</p>
          <SimpleTable
            rows={vendors}
            columns={[
        ...
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Purchase Orders</p>
          <SimpleTable
            rows={orders}
            columns={[
