    ...
    <div className="space-y-5">
      ...
      <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <GlassCard>
          ...
          <p className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{summary.totalDocuments}</p>
        ...
        <GlassCard>
          ...
          <p className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{summary.internshipCertificates}</p>
        ...
        <GlassCard>
          ...
          <p className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{summary.pendingReview}</p>
        ...
        <GlassCard>
          ...
          <p className="mt-2 text-2xl font-semibold text-slate-900 dark:text-slate-100">{summary.workflowGenerated}</p>
      ...
      <section className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
        <GlassCard>
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Latest Internship Packet</p>
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
              ...
              <p className="mt-2 text-sm font-semibold text-slate-900 dark:text-slate-100">{latestPacket?.university ?? 'Ready for next packet'}</p>
            </div>
            <div className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
              <p className="text-xs uppercase tracking-[0.12em] text-slate-500">Mentor</p>
              <p className="mt-2 text-sm font-semibold text-slate-900 dark:text-slate-100">{latestPacket?.mentorName ?? 'Waiting for assignment'}</p>
            </div>
            <div className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
            ...
            <div className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
              ...
              <p className="mt-2 text-sm font-semibold text-slate-900 dark:text-slate-100">{latestPacket?.approverName ?? 'HR Manager queue'}</p>
            </div>
          </div>
            ...
            {latestPacket?.projectHighlights?.length ? (
              <ul className="space-y-2">
                {latestPacket.projectHighlights.map((highlight) => (
                  <li key={highlight} className="rounded-lg border border-slate-200/80 bg-white/70 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/60">
                    {highlight}
                  </li>
                ))}
              </ul>
        ...
        <GlassCard>
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Workflow Steps</p>
          <div className="mt-4 space-y-3">
            {workflowSteps.length > 0 ? workflowSteps.map((step) => (
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300">Workflow steps will appear once the live automation module responds.</p>
            )}
          </div>
        </GlassCard>
      </section>
