...
export function RoleDashboardView() {
  ...
  const commandTiles = [
    {
      ...
      className:
        'from-emerald-500/15 to-emerald-500/5 text-emerald-700 dark:text-emerald-200',
    },
    {
      ...
      icon: Bell,
      className: 'from-amber-500/15 to-amber-500/5 text-amber-700 dark:text-amber-200',
    },
    {
      ...
      icon: Radar,
      className: 'from-sky-500/15 to-sky-500/5 text-sky-700 dark:text-sky-200',
    },
    {
  ...
  return (
    <div className="space-y-5">
      <section className="relative overflow-hidden rounded-[30px] border border-slate-200/70 bg-[radial-gradient(circle_at_top_left,_rgba(15,139,141,0.16),_transparent_36%),radial-gradient(circle_at_bottom_right,_rgba(232,90,42,0.16),_transparent_34%),linear-gradient(135deg,rgba(255,255,255,0.96),rgba(255,255,255,0.84))] p-5 shadow-panel backdrop-blur dark:border-slate-700/70 dark:bg-[radial-gradient(circle_at_top_left,_rgba(15,139,141,0.3),_transparent_36%),radial-gradient(circle_at_bottom_right,_rgba(232,90,42,0.22),_transparent_34%),linear-gradient(135deg,rgba(15,23,42,0.92),rgba(15,23,42,0.82))] sm:p-6 lg:p-7">
        <div className="pointer-events-none absolute inset-y-0 right-0 w-1/2 bg-[radial-gradient(circle_at_top_right,_rgba(255,255,255,0.28),_transparent_50%)] dark:bg-[radial-gradient(circle_at_top_right,_rgba(148,163,184,0.18),_transparent_50%)]" />
        <div className="relative grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-5">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="inline-flex rounded-full border border-slate-300/80 bg-white/70 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-600 dark:border-slate-700/70 dark:bg-slate-900/70 dark:text-slate-300">
            ...
            <div className="rounded-3xl border border-white/70 bg-white/70 p-4 shadow-sm backdrop-blur dark:border-slate-700/70 dark:bg-slate-900/55">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-4 py-2 text-xs font-semibold text-slate-700 transition hover:border-slate-400 disabled:cursor-not-allowed disabled:opacity-45 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
            ...
            <div>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {recentModules.map((moduleName) => (
                  <span
                    key={moduleName}
                    className="rounded-full border border-slate-300/80 bg-white/75 px-3 py-1.5 text-xs font-semibold text-slate-700 dark:border-slate-700/70 dark:bg-slate-900/60 dark:text-slate-200"
                  >
                    {moduleName}
                  </span>
                ))}
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
            {commandTiles.map((tile) => {
              ...
              return (
                <div
                  key={tile.label}
                  className={`rounded-3xl border border-white/70 bg-gradient-to-br ${tile.className} p-4 shadow-sm backdrop-blur dark:border-slate-700/70`}
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="rounded-2xl border border-white/70 bg-white/60 p-2.5 dark:border-slate-700/70 dark:bg-slate-900/55">
                      <Icon size={18} />
                    </div>
                  </div>
      ...
      <section className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="mt-5 space-y-4">
            {topPipelineStages.map((item) => {
              ...
              return (
                <div
                  key={item.stage}
                  className="rounded-2xl border border-slate-200/80 bg-white/70 p-4 dark:border-slate-700/70 dark:bg-slate-900/50"
                >
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">{item.stage}</p>
        ...
        <GlassCard className="overflow-hidden">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-200/80 bg-white/70 p-4 dark:border-slate-700/70 dark:bg-slate-900/50">
              <div className="flex items-center gap-2">
          ...
          <div className="mt-4 rounded-2xl border border-slate-200/80 bg-white/70 p-4 dark:border-slate-700/70 dark:bg-slate-900/50">
