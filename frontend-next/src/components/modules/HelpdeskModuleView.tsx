...
export function HelpdeskModuleView() {
 ...
 <p className="text-[11px] text-amber-700 ">Support actions are restricted by active role policy.</p>
 ) : null}
 </div>
 }
 />
 ...
 <p className="text-sm font-semibold text-slate-800 ">Support Ticket Queue</p>
 <SimpleTable
 rows={tickets}
 columns={[
