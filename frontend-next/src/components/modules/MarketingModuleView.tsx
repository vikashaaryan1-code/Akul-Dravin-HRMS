...
export function MarketingModuleView() {
 ...
 <p className="text-sm font-semibold text-slate-800 ">Marketing Spend Snapshot</p>
 <p className="text-2xl font-semibold text-slate-900 ">{formatCurrency(totals.totalSpend)}</p>
 ...
 <section>
 <GlassCard className="space-y-3">
 <p className="text-sm font-semibold text-slate-800 ">Campaign Operations</p>
 <SimpleTable
 rows={campaigns}
 columns={[
