  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        ...
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Customer Accounts</p>
          <div className="space-y-3">
            {customers.map((account) => (
              ...
              >
                ...
                <p className="mt-2 text-sm font-semibold text-slate-700 dark:text-slate-200">{formatCurrency(account.annualValue)} ARR</p>
              </div>
            ))}
          </div>
        </GlassCard>
      ...
      <section>
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Interaction Timeline</p>
          <SimpleTable
            rows={interactions}
            columns={[
