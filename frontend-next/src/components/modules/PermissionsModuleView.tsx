    ...
    <div className="space-y-5">
      <PageTitle
        ...
        actions={
          <div className="flex flex-col items-start gap-2">
            ...
            {!canGrant || !canRevoke ? (
              <p className="text-[11px] text-amber-700 dark:text-amber-300">Permission actions are limited by active role policy.</p>
            ) : null}
          </div>
        }
      />
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Role Permission Matrix</p>
          <SimpleTable
            columns={[
        ...
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Permission Audit Logs</p>
          <SimpleTable
            columns={[
