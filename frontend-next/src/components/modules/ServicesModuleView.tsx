...
export function ServicesModuleView() {
 ...
 <GlassCard>
 <p className="text-sm font-semibold text-slate-800 ">Service Queue Overview</p>
 ...
 <GlassCard>
 <p className="text-sm font-semibold text-slate-800 ">Employee Self-Service Health</p>
 <ul className="mt-3 space-y-2 text-sm text-slate-600 ">
