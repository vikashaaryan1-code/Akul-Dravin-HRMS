    ...
    <div className="space-y-5">
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Work Activity Log</p>
          <SimpleTable
            columns={[
        ...
        <GlassCard className="space-y-3">
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Workday Analytics</p>
          <SimpleTable
            columns={[
              { key: 'employeeName', label: 'Employee' },
