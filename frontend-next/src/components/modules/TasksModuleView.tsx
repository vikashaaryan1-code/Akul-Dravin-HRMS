...
export function TasksModuleView() {
 ...
 <GlassCard>
 <p className="text-sm font-semibold text-slate-800 ">Task Priority Snapshot</p>
 ...
 <p className="text-sm font-semibold text-slate-800 ">Task Assignment Board</p>
 <SimpleTable
 columns={[
 ...
 <GlassCard className="space-y-3">
 <p className="text-sm font-semibold text-slate-800 ">Project Tracker</p>
 <SimpleTable
 columns={[
