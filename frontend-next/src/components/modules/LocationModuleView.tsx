  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        ...
        <GlassCard>
          <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Location Governance</p>
      ...
      <GlassCard className="space-y-3">
        <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Current Employee Location Snapshot</p>
        <SimpleTable
          columns={[
