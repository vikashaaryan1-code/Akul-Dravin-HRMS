...
/* ── Sortable Step Item ───────────────────────────────────────────────────── */ interface SortableStepProps {
 id: string;
...
export function SortableStep({ id, children }: SortableStepProps) {
 ...
 {...attributes}
 {...listeners}
 className="absolute left-[-28px] top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 cursor-grab active:cursor-grabbing p-1 rounded-lg text-slate-600 hover:text-slate-500 transition-opacity z-10"
