...
/* ── DTO-shaped mock data ────────────────────────────────────────────────────── */ const PAYROLL_KPIS = [
...
/* ── Cycle Status Banner ─────────────────────────────────────────────────────── */ type CyclePhase = 'draft' | 'review' | 'processing' | 'disbursed';
...
export function PayrollDashboard() {
 ...
 <td className="py-3 pr-4 font-bold text-navy">{row.name}</td>
 <td className="py-3 pr-4 text-slate-500">{row.dept}</td>
