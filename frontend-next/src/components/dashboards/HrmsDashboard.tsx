...
// ── Fallback data ─────────────────────────────────────────────────────────────
const FALLBACK_KPIS: HrmsKpiDto = {
...
// ── Live Attendance Trend Chart ───────────────────────────────────────────────
function LiveAttendanceChart() {
              ...
              <tbody>
                {employees.map((emp) => (
                  <tr key={emp.id} className="border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors group">
                    ...
                    <td className="py-3 pr-4 text-slate-400">{emp.dept}</td>
          ...
          return (
            <div key={stage.stage}>
              <div className="flex justify-between text-xs mb-1.5">
                <span className="text-slate-400 font-semibold">{stage.stage}</span>
  ...
  return (
    <section aria-labelledby="hrms-heading">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-400 mt-1">Real-time people analytics · live from backend</p>
      </div>
