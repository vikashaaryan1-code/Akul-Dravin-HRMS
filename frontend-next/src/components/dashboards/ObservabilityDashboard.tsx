...
/* ── DTO-shaped mock data ────────────────────────────────────────────────────── */ const OBS_KPIS = [
...
/* ── Live Queue Feed ─────────────────────────────────────────────────────────── */ function LiveQueueFeed({ enabled }: { enabled: boolean }) {
...
/* ── Service Health Grid ─────────────────────────────────────────────────────── */ function ServiceHealthGrid() {
 return (
 ...
 <p className="flex-1 text-xs font-bold text-navy">{svc.name}</p>
...
/* ── Worker Node Panel ───────────────────────────────────────────────────────── */ function WorkerNodePanel() {
 return (
 <GlassCard className="p-6 flex flex-col gap-4">
 <div className="flex items-center gap-2">
 ...
 <span className="font-bold text-navy font-mono">{node.node}</span>
 </div>
...
export function ObservabilityDashboard() {
 const [wsEnabled] = useState(false); /* Phase 3C: set true when WS gateway live */ return (
