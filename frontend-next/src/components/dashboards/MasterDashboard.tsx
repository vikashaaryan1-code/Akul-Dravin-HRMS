...
const MasterDashboard = () => {
 ...
 return (
 <div className={`min-h-screen bg-slate-50 text-white p-8 cyber-mesh transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
 {/* Header */}
 ...
 <span className={`text-sm ${stat.change.startsWith('+') ? 'text-emerald-400' : 'text-slate-500'}`}>
 {stat.change}
 </span>
 </div>
