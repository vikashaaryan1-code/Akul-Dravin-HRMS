...
/* ── DTO-shaped mock data ────────────────────────────────────────────────────── */ const ANALYTICS_KPIS = [
...
/* ── Period Selector ─────────────────────────────────────────────────────────── */ function PeriodSelector({ value, onChange }: { value: Period; onChange: (p: Period) => void }) {
 return (
...
/* ── Geo Breakdown Panel ─────────────────────────────────────────────────────── */ function GeoBreakdown() {
 return (
...
/* ── Department Productivity Table ───────────────────────────────────────────── */ function ProductivityTable() {
 return (
 <GlassCard className="p-6 flex flex-col gap-4">
 ...
 <td className="py-2.5 pr-4 font-bold text-navy">{row.dept}</td>
 <td className="py-2.5 pr-4">
 <span className={`font-black ${row.revPerHead > 30 ? 'text-jade' : row.revPerHead > 20 ? 'text-gold' : 'text-slate-600'}`}>
 {row.revPerHead}
 </span>
 </td>
 <td className="py-2.5">
 ...
 <span className="font-black text-slate-600">{row.efficiency}%</span>
 </div>
 </td>
 </tr>
 ))}
