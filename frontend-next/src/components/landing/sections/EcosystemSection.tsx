  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        <div className={`h-11 w-11 rounded-xl bg-white/5 border border-white/8 flex items-center justify-center
      ...
      <div>
        <h3 className="text-lg font-black tracking-tight text-white">{product.title}</h3>
        <p className="text-sm text-slate-400 mt-1 leading-relaxed">{product.description}</p>
      </div>
