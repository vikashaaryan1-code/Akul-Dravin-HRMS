      ...
      <div className="container-brand relative z-10">
        <div className="flex flex-col items-center text-center max-w-[1000px] mx-auto gap-8">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full border border-white/10 bg-white/[0.04] backdrop-blur-xl"
          >
          ...
          <motion.h1
            ...
            className="text-[clamp(2.6rem,7vw,6.5rem)] font-black tracking-tightest leading-[0.92] text-white"
          >
          ...
          <motion.p
            ...
            className="max-w-[680px] text-lg lg:text-xl text-slate-400 leading-relaxed"
          >
            {hero.description}
          </motion.p>
          ...
          >
            <Link
              ...
              id="hero-primary-cta"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-gold to-ember text-void text-sm font-black uppercase tracking-wide shadow-ember-md hover:shadow-ember-lg hover:scale-105 active:scale-95 transition-all duration-300"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full surface-raised border-subtle text-sm font-bold text-white hover:bg-white/10 transition-all duration-300"
            >
