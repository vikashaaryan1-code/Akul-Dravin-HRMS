...
export function AiCopilotSection() {
 ...
 msg.role === 'user'
 ? 'bg-white/8 border border-navy/10 text-slate-700'
 : 'bg-depth-2 border border-navy/5 text-slate-600'
 }`}
 >
 {msg.text}
 </div>
 ...
 {activeTab === 'analytics' && (
 <div className="space-y-4">
 <p className="text-sm font-bold text-navy mb-6">Predictive Analytics Dashboard</p>
 {[
 ...
 <p className="text-sm font-bold text-navy mb-4">Digital Twin — Org Simulation</p>
 ...
 className="flex gap-4 surface-base border-subtle rounded-2xl p-5 hover:bg-navy/5 transition-colors duration-300"
 >
 <div className={`h-10 w-10 rounded-xl bg-navy/5 border border-white/8 flex items-center justify-center shrink-0`}>
