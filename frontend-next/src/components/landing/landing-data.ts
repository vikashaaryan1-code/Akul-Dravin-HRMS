...
export const PRICING_PLANS: PricingPlan[] = [
  {
    name: 'Free',
    price: '₹0',
    description: 'Trial (1–5 Employees)',
  ...
  },
  {
    name: 'HR Lite',
    price: '₹999',
    description: 'HR के लिए - Small Office (6–25 Employees)',
    cta: 'Get HR Lite',
    features: [
      'Employee Master',
      'Attendance & Leave',
  ...
  },
  {
    name: 'HR Pro',
    price: '₹2,499',
    description: 'HR + Recruitment - SMEs (26–50 Employees)',
    cta: 'Get HR Pro',
    featured: true,
    features: [
      'HR Lite के सभी फीचर्स',
      'Recruitment (ATS)',
      'Resume Database',
  ...
  },
  {
    name: 'HR + Payroll',
    price: '₹4,999',
    description: 'HR + Accountant के लिए - Growing Companies (51–100 Employees)',
    cta: 'Get HR + Payroll',
    features: [
      'HR Pro के सभी फीचर्स',
      'Payroll Processing',
      'Salary Structure, PF, ESI, TDS, PT',
      'Bonus & Incentives',
  ...
  },
  {
    name: 'Business HRMS',
    price: '₹9,999',
    description: 'HR + Accountant + Admin - Medium Business (101–250 Employees)',
    cta: 'Get Business HRMS',
    features: [
      'HR + Payroll के सभी फीचर्स',
      'Multi Branch & Multi Company',
      'Geo & Biometric Attendance',
      'Visitor & Asset Management',
      'Helpdesk & Approval Workflow',
  ...
  },
  {
    name: 'Premium HRMS',
    price: '₹17,999',
    description: 'बड़े व्यवसायों के लिए - Large Business (251–500 Employees)',
    cta: 'Get Premium HRMS',
    features: [
      'Premium Analytics',
      'AI HR Assistant & Recruitment',
      'Face Recognition Attendance',
      'Predictive Analytics & Budget Planning',
      'Custom Workflow & SSO Login',
      'Custom Branding (White Label विकल्प)',
  ...
  },
  {
    name: 'Enterprise',
    price: 'Custom',
    description: 'Corporate & Enterprise (500+ Employees)',
    cta: 'Talk to Sales',
    features: [
      'Unlimited Employees & Multi-Country',
      'Dedicated Server / Cloud',
      'SAP / Tally ERP Integration',
      'Custom Development',
      'Dedicated Success Manager',
      '24x7 Premium Support & SLA',
      'Advanced Security',
      'AI Resume Screening & Digital Signature',
      'HR Chatbot & WhatsApp Business API'
    ],
  },
];
