...
export function AutomationSection() {
 ...
 >
 <p className="inline-flex rounded-full bg-slate-50mber/20 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-ember">
 {item.tag}
 </p>
 ...
 <aside className="relative overflow-hidden rounded-3xl border border-slate-100 bg-ink p-6 text-navy shadow-panel">
 <div className="absolute -right-14 -top-14 h-40 w-40 rounded-full bg-slate-50mber/25 blur-3xl" />
 <div className="absolute -bottom-16 -left-12 h-40 w-40 rounded-full bg-aqua/30 blur-3xl" />
 <div className="relative space-y-5">
 <p className="text-xs uppercase tracking-[0.18em] text-navy/70">Automation Control Tower</p>
 ...
 <div className="h-1.5 rounded-full bg-navy/10">
 <div className="h-1.5 w-[94%] rounded-full bg-slate-50mber-200" />
 </div>
 </div>
 </div>
 </aside>
