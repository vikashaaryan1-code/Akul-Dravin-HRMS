...
export function ServicesSection() {
 return (
 <section id="services" className="relative py-24 lg:py-32 px-4 lg:px-8 bg-slate-50 overflow-hidden">
 {/* Decorative Blur */}
 ...
 <div className="relative h-[300px] sm:h-[450px] overflow-hidden rounded-[1.5rem] border border-navy/5">
 <Image
 src={service.image}
 alt={service.title}
 fill
 ...
 <div className="absolute -bottom-6 -right-6 glass-panel p-4 rounded-2xl border-navy/20 hidden sm:block shadow-2xl">
 ...
 <div>
 <span className="inline-block px-4 py-1.5 rounded-full glass-panel text-[10px] font-bold text-indigo-400 uppercase tracking-widest mb-6 border-navy/10">
 {service.badge}
 </span>
 <h3 className="text-4xl sm:text-5xl font-extrabold text-navy leading-tight mb-4">
 {service.title}
 </h3>
 ...
 <div className="pt-8">
 <button className="px-8 py-4 rounded-full border border-navy/10 glass-button text-navy font-bold text-sm hover:border-white/30 transition-all group">
