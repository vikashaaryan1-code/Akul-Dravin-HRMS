...
const INPUT_STYLES =
  'w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-500 focus:border-amber/60 focus:bg-white/10';
        ...
        <form className="grid gap-4 md:grid-cols-2" onSubmit={submitInquiry}>
          ...
          <label className="space-y-2 text-sm text-slate-300">
            ...
            <select
              ...
              name="interestArea"
            >
              <option className="bg-slate-900 text-white">Full platform rollout</option>
              <option className="bg-slate-900 text-white">HRMS transformation</option>
              <option className="bg-slate-900 text-white">CRM + sales operations</option>
              <option className="bg-slate-900 text-white">Finance + billing stack</option>
              <option className="bg-slate-900 text-white">White-label / enterprise deployment</option>
            </select>
          </label>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-xl">
          ...
          <form className="mt-5 space-y-4" onSubmit={submitNewsletter}>
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center rounded-full border border-white/15 bg-white/10 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/15 disabled:cursor-not-allowed disabled:opacity-60"
            >
