...
export function A2zWorkflowForm({ options }: A2zWorkflowFormProps) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
      <form id="a2z-form" className="grid gap-4 rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-xl md:grid-cols-2" onSubmit={submit}>
      ...
      <div className="space-y-5">
        <div className="rounded-[2rem] border border-white/10 bg-[#07192e] p-6 shadow-2xl">
          ...
          <div className="space-y-4 rounded-[2rem] border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
            ...
            <div className="space-y-3">
              {submissionState.workflowPlan.map((step) => (
                <article key={step.phase} className="rounded-2xl border border-white/10 bg-[#04101f] p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-300">Owner: {step.owner}</p>
                  <p className="mt-1 text-sm text-slate-400">ETA: {step.eta}</p>
                </article>
              ))}
            </div>
          </div>
