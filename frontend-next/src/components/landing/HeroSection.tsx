...
function ArchDiagram() {
  ...
  return (
    <div className="relative w-full max-w-xl mx-auto">
      ...
      <div className="relative rounded-3xl border border-white/10 bg-[#04101f]/80 backdrop-blur-xl p-6 space-y-2 shadow-2xl">
        {/* Live badge */}
        <div className="flex items-center justify-between mb-4">
          <span className="text-[10px] font-mono text-slate-400 uppercase tracking-widest">Architecture Stack</span>
        ...
        {/* Layer cards */}
        {layers.map((layer, i) => (
          <div key={i} className="flex items-center gap-3 px-4 py-3 rounded-2xl border border-white/5 bg-white/[0.03] hover:bg-white/[0.06] transition group">
    ...
    >
      ...
      <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2 lg:items-center relative z-10 w-full">
        ...
        <div className="space-y-8 animate-rise">
          ...
          {/* H1 */}
          <h1 className="text-balance text-5xl font-extrabold leading-[1.05] tracking-tighter text-white sm:text-6xl lg:text-7xl">
            Sovereign
            <br />
          ...
          {/* Sub-headline */}
          <p className="max-w-lg text-lg leading-relaxed text-slate-400 border-l-2 border-pink-500/30 pl-5">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <Link
              href="/login"
              className="px-8 py-4 rounded-full bg-gradient-to-r from-blue-600 to-violet-600 text-white font-bold text-sm shadow-[0_0_30px_rgba(59,130,246,0.35)] hover:scale-[1.03] hover:shadow-[0_0_40px_rgba(59,130,246,0.5)] transition-all duration-300 active:scale-95"
            >
              Enter Platform
            </Link>
            <Link
              href="#contact"
              className="px-8 py-4 rounded-full border border-white/15 bg-white/5 text-white font-bold text-sm hover:bg-white/10 hover:border-white/25 transition-all duration-300 backdrop-blur-sm"
            >
              Book Demo
            </Link>
          </div>
