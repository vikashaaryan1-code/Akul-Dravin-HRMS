...
export const TalentUniverse = () => {
 ...
 useEffect(() => {
 /* Simulate fetching candidates */ setTimeout(() => {
 setCandidates([
 ...
 <p className="text-gray-500 mt-2 text-lg">Autonomous Candidate Matching & Scoring</p>
 </header>
 ...
 <p className="text-gray-500 text-sm mt-1">{c.role}</p>
 <div className="flex gap-2 mt-3">
 {c.skills.map((s) => (
 <span key={s} className="px-3 py-1 text-xs bg-white/10 rounded-full text-gray-600">
 {s}
 </span>
 ))}
 </div>
 ...
 <div>
 <label className="text-xs text-gray-500 uppercase tracking-wider block mb-1">Job Title</label>
 ...
 <p className="text-sm text-gray-600">Drag & drop resume PDF here</p>
