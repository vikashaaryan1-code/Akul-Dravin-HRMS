...
// Inner component for the 3D rotating globe
const Globe = () => {
...
export const AICommandBridge = () => {
  ...
  useEffect(() => {
    // Initialize WebSocket Connection to the NestJS Gateway
    const socket: Socket = io(process.env.NEXT_PUBLIC_WS_URL || 'http://localhost:3000/command-bridge', {
      ...
      <div className="relative z-10 p-8 h-screen flex flex-col justify-between pointer-events-none">
        ...
        <header className="flex justify-between items-center">
          ...
          >
            ...
            <p className="text-gray-400 text-sm mt-1">Global Workforce Executive Overview</p>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pointer-events-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center pb-2 border-b border-white/5">
                <span className="text-gray-400 text-sm">Payroll Status</span>
          ...
          >
            <h2 className="text-sm font-medium text-gray-400 mb-3 border-b border-white/10 pb-2">System Terminal</h2>
