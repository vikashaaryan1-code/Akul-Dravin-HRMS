...
export function TopNavigation({ onMenuClick }: TopNavigationProps) {
 ...
 return (
 <header className="sticky top-0 z-40 border-b border-white/10 bg-white/80 glass-3d-panel !rounded-none !border-x-0 !border-t-0 ">
 <div className="mx-auto flex h-16 max-w-[1500px] items-center gap-2 px-3 sm:px-4 lg:px-6">
 <button
 type="button"
 onClick={onMenuClick}
 aria-label="Open menu"
 className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-slate-200 text-slate-700 hover:bg-slate-50 lg:hidden "
 >
 <Menu size={18} />
 </button>
 ...
 <span className="hidden text-sm font-bold tracking-[0.18em] text-slate-900 sm:inline ">{PLATFORM_BRAND}</span>
 </Link>
 ...
 {moreOpen && (
 <div className="absolute left-0 top-full mt-2 w-48 rounded-xl border border-slate-200 bg-white p-2 shadow-xl max-h-96 overflow-y-auto">
 ...
 className="hidden min-w-0 flex-1 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-500 lg:flex hover:border-blue-300 transition cursor-pointer"
 aria-label="Open command palette"
 >
 <Search size={15} className="shrink-0" />
 <span className="flex-1 text-left min-w-0 text-slate-500 text-sm">Search anything...</span>
 <kbd className="hidden xl:flex gap-0.5 px-1.5 py-0.5 rounded text-[10px] font-mono bg-slate-100 text-slate-500">⌘K</kbd>
 </button>
 ...
 className="hidden max-w-[190px] shrink-0 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 outline-none lg:block "
 ...
 type="button"
 onClick={toggleTheme}
 className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-slate-200 text-slate-700 hover:bg-slate-50 "
 ...
 className="relative inline-flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 text-slate-700 hover:bg-slate-50 "
 aria-label="Notifications"
 >
 <Bell size={16} />
 {unreadCount > 0 ? (
 <span className="absolute right-1 top-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-ember px-1 text-[10px] font-bold text-navy">
 ...
 className="inline-flex h-10 w-10 overflow-hidden items-center justify-center rounded-full bg-white text-xs font-bold text-navy "
 ...
 <Link href={`/settings?role=${safeRole}`} className="block rounded-lg px-3 py-2 text-sm text-slate-700 hover:bg-slate-100 ">
 Account Settings
 </Link>
 <button
 type="button"
