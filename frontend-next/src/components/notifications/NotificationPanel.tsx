...
export function NotificationPanel() {
 ...
 return (
 <div className="absolute right-0 top-14 z-50 w-[min(420px,92vw)] rounded-2xl border border-slate-200/90 bg-white/95 p-3 shadow-2xl backdrop-blur-lg ">
 ...
 <article
 key={notification.id}
 className={`rounded-xl border border-slate-200/80 border-l-4 bg-white p-3 ${toneMap[notification.type]}`}
 >
