...
export class AppErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, info: React.ErrorInfo) {
    ...
    // Future: ship to Sentry / OpenTelemetry
          ...
          {({ reset }) => (
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/10 bg-white/5 text-xs font-bold text-white hover:bg-white/10 transition-colors duration-200"
