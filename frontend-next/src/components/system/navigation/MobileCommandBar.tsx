...
/* ── Nav items (mirrors ExecutiveSidebar) ────────────────────────────────────── */ const MOBILE_NAV = [
 {
 group: 'Dashboards',
 items: [
...
/* ── Mobile Nav Sheet ────────────────────────────────────────────────────────── */ export function MobileNavSheet({
 open,
 onClose,
 notificationCount = 0,
}: {
 ...
 className="relative h-9 w-9 rounded-xl bg-white/5 border border-white/8 flex items-center justify-center text-slate-500"
 >
 ...
 className="h-9 w-9 rounded-xl bg-white/5 border border-white/8 flex items-center justify-center text-slate-500 hover:text-white transition-colors"
 >
 ...
 href={item.href}
 onClick={onClose}
 className="flex items-center gap-3 px-3 py-3 rounded-xl text-slate-500 hover:text-white hover:bg-white/[0.05] active:bg-white/[0.08] transition-colors group min-h-[48px]"
 >
...
/* ── Hamburger trigger (inline use in TopCommandBar) ──────────────────────────── */ export function HamburgerButton({
 open,
 onToggle,
}: {
 open: boolean;
