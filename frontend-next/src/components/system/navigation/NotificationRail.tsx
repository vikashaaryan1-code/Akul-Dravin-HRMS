...
/* Mock notifications — Phase 3C will replace with real-time stream */ const MOCK_NOTIFICATIONS: Notification[] = [
...
/* ── NotificationItem ────────────────────────────────────────────────────────── */ function NotificationItem({ item, onDismiss }: { item: Notification; onDismiss: (id: string) => void }) {
...
/* ── NotificationRail ────────────────────────────────────────────────────────── */ interface NotificationRailProps {
 open: boolean;
 onClose: () => void;
}
