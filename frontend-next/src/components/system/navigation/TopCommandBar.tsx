...
/* ── GlobalSearch ────────────────────────────────────────────────────────────── */ function GlobalSearch() {
 ...
 href={item.href}
 onClick={() => setOpen(false)}
 className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-600 hover:text-white hover:bg-white/5 transition-colors"
 >
...
/* ── UserMenu ────────────────────────────────────────────────────────────────── */ function UserMenu() {
 ...
 if (!user) return (
 <Link href="/login" className="text-xs font-bold text-slate-500 hover:text-white transition-colors">
 Sign In
 </Link>
 );
 ...
 item.danger ? 'text-ember hover:text-ember' : 'text-slate-600 hover:text-white'
 }`}
 >
...
/* ── TopCommandBar ───────────────────────────────────────────────────────────── */ interface TopCommandBarProps {
