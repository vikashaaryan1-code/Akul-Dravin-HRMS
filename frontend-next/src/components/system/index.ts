...
// ── Error & Suspension ────────────────────────────────────────────────────────
export { AppErrorBoundary, QueryAwareErrorBoundary } from './ErrorBoundary';
export {
...
// ── Cards & KPI Tiles ─────────────────────────────────────────────────────────
export { GlassCard, KpiTile, KpiStrip, TrendBadge } from './cards/GlassCard';

// ── Charts (static — for use in non-critical sections) ───────────────────────
export {
  ChartContainer,
  AreaTrendChart,
  BarTrendChart,
...
// ── Charts (dynamic — SSR-safe, lazy loaded for heavy dashboard panels) ───────
export {
  DynamicAreaChart,
  DynamicBarChart,
  DynamicDonutChart,
...
// ── Data Display ──────────────────────────────────────────────────────────────
export { VirtualTable } from './data-display/VirtualTable';

// ── Navigation ────────────────────────────────────────────────────────────────
export { ExecutiveSidebar } from './navigation/ExecutiveSidebar';
